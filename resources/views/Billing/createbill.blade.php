...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
        ...
        <!-- Left Sidebar Start  -->
        @include('Layout.Billing.Billing_sidebar')
        <!-- Left Sidebar End -->
        ...
        <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Food</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">View Bill</a></li>
                                        ...
                                        <table id="datatable-buttons" class="table table-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button data-bs-toggle="modal" data-bs-target="#edititem"
                                                            data-id="{{$item->locatorId}}"
                                                            class="btn btn-outline-warning btn-sm waves-effect waves-light">Edit
                                                        </button> </td>
                                                    <td><a href="{{url('deleteLocator').$item->locatorId}}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <button class="btn btn-primary waves-effect waves-light"
                                                    data-bs-toggle="modal" data-bs-target="#itemAddModal">Add
                                                    Item</button>
                                            </div>
                                        </div>
                                        <br>
                        ...
                        <div class="modal-body">
                            <form action="{{url('insertLocator')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="InlocatorId" name="InlocatorId"
                                        required>
                                </div>
                                <div class="mb-3">
            ...
            {{--        item Edit modal--}}
            <div id="edititem" class="modal fade" tabindex="-1" aria-labelledby="editLocator" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="{{url('editLocator')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="" class="form-label">Rate</label>
                                    <input type="text" class="form-control" id="EditlocatorDescription"
                                        name="EditlocatorDescription" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Quantity</label>
                                    <input type="text" class="form-control" id="id" name="id" readonly hidden>
