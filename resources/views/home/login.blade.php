            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="card-body pt-0">
                        <div class="auth-logo">
                            ...
                            <a href="index.html" class="auth-logo-dark">
                                <div class="avatar-md profile-user-wid mb-4">
                                            <span class="title ">
                                                <img src="assets/images/awakaza.png" alt=""height="50">
                                            </span>
                                </div>
                            </a>
                        </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>© <script>document.write(new Date().getFullYear())</script>  <img src="assets/images/awakaza.ico" alt="" class="rounded-circle" height="50"> by <a href="https://circlebook.site/" class="success"> Circlebook Pvt Ltd </a></p>
                    </div>
                </div>
            </div>
            </div>
