	...
	<div class="container-fluid"  height: 95vh;">
		...
		<div class="row" style="margin:1vh;">
			...
			@else
				<a href="" data-toggle="modal" data-target="#accessDeniedPopUp">
			@endif
					<div class="card p-0 card_style">
						<center><img class="card-img-top cardAnimationSet1" src="assets/images/mainDash/bill.jpg" alt="Card image cap" style="height: 31vh;"></center>
						<div class="card-body">
